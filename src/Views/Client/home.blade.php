    ...
    <section class="slider__area p-relative">
        <div class="slider-active">
            <div class="single-slider slider__height d-flex align-items-center"
                data-background="public/assets/client/assets/img/slider/slider-1.jpg">
                <div class="container">
                    <div class="row">
            ...
            <div class="single-slider slider__height d-flex align-items-center"
                data-background="public/assets/client/assets/img/slider/slider-2.jpg">
                <div class="container">
                    <div class="row">
            ...
            <div class="single-slider slider__height d-flex align-items-center"
                data-background="public/assets/client/assets/img/slider/slider-3.jpg">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 col-12">
                            <div class="slider__content">
                    ...
                    <div class="product__slider owl-carousel">
                        <div class="product__item">
                            <div class="product__wrapper mb-60">
                                <div class="product__thumb">
                                    <a href="{{ $_ENV['BASE_URL'] }}/product-detail" class="w-img">
                                        <img src="public/assets/client/assets/img/shop/product/product-1.jpg"
                                            alt="product-img">
                            ...
                            <div class="product__wrapper mb-60">
                                <div class="product__thumb">
                                    <a href="product-details.html" class="w-img">
                                        <img src="public/assets/client/assets/img/shop/product/product-5.jpg"
                                            alt="product-img">
                                        <img class="product__thumb-2"
                                            src="public/assets/client/assets/img/shop/product/product-11.jpg"
                                            alt="product-img">
                                    </a>
                                    <div class="product__action transition-3">
                                        <a href="#" data-toggle="tooltip" data-placement="top"
                        ...
                        <div class="product__item">
                            <div class="product__wrapper mb-60">
                                <div class="product__thumb">
                                    <a href="product-details.html" class="w-img">
                                        <img src="public/assets/client/assets/img/shop/product/product-2.jpg"
                                            alt="product-img">
                                        <img class="product__thumb-2"
                                            src="public/assets/client/assets/img/shop/product/product-9.jpg"
                                            alt="product-img">
                                    </a>
                                    <div class="product__action transition-3">
                                        <a href="#" data-toggle="tooltip" data-placement="top"
                            ...
                            <div class="product__wrapper mb-60">
                                <div class="product__thumb">
                                    <a href="product-details.html" class="w-img">
                                        <img src="public/assets/client/assets/img/shop/product/product-6.jpg"
                                            alt="product-img">
                                        <img class="product__thumb-2"
                                            src="public/assets/client/assets/img/shop/product/product-7.jpg"
                                            alt="product-img">
                                    </a>
                                    <div class="product__action transition-3">
                                        <a href="#" data-toggle="tooltip" data-placement="top"
                        ...
                        <div class="product__item">
                            <div class="product__wrapper mb-60">
                                <div class="product__thumb">
                                    <a href="product-details.html" class="w-img">
                                        <img src="public/assets/client/assets/img/shop/product/product-3.jpg"
                                            alt="product-img">
                                        <img class="product__thumb-2"
                                            src="public/assets/client/assets/img/shop/product/product-8.jpg"
                                            alt="product-img">
                                    </a>
                                    <div class="product__action transition-3">
                                        <a href="#" data-toggle="tooltip" data-placement="top"
                            ...
                            <div class="product__wrapper mb-60">
                                <div class="product__thumb">
                                    <a href="product-details.html" class="w-img">
                                        <img src="public/assets/client/assets/img/shop/product/product-7.jpg"
                                            alt="product-img">
                                        <img class="product__thumb-2"
                                            src="public/assets/client/assets/img/shop/product/product-1.jpg"
                                            alt="product-img">
                                    </a>
                                    <div class="product__action transition-3">
                                        <a href="#" data-toggle="tooltip" data-placement="top"
                        ...
                        <div class="product__item">
                            <div class="product__wrapper mb-60">
                                <div class="product__thumb">
                                    <a href="product-details.html" class="w-img">
                                        <img src="public/assets/client/assets/img/shop/product/product-4.jpg"
                                            alt="product-img">
                                        <img class="product__thumb-2"
                                            src="public/assets/client/assets/img/shop/product/product-12.jpg"
                                            alt="product-img">
                                    </a>
                                    <div class="product__action transition-3">
                                        <a href="#" data-toggle="tooltip" data-placement="top"
                            ...
                            <div class="product__wrapper mb-60">
                                <div class="product__thumb">
                                    <a href="product-details.html" class="w-img">
                                        <img src="public/assets/client/assets/img/shop/product/product-8.jpg"
                                            alt="product-img">
                                        <img class="product__thumb-2"
                                            src="public/assets/client/assets/img/shop/product/product-3.jpg"
                                            alt="product-img">
                                    </a>
                                    <div class="product__action transition-3">
                                        <a href="#" data-toggle="tooltip" data-placement="top"
            ...
            <div class="row no-gutters">
                    ...
                    <div class="banner__item-2 banner-right p-relative mb-30 pr-15">
                        <div class="banner__thumb fix">
                            <a href="product-details.html" class="w-img"><img
                                    src="public/assets/client/assets/img/shop/banner/banner-big-1.jpg" alt="banner"></a>
                        </div>
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class=" banner__item-2 banner-left p-relative mb-30 pl-15">
                        <div class="banner__thumb fix">
                            <a href="product-details.html" class="w-img"><img
                                    src="public/assets/client/assets/img/shop/banner/banner-big-2.jpg" alt="banner"></a>
                        </div>
                                ...
                                <div class="product__thumb">
                                    <a href="product-details.html" class="w-img">
                                        <img src="public/assets/client/assets/img/shop/product/product-6.jpg"
                                            alt="product-img">
                                        <img class="product__thumb-2"
                                            src="public/assets/client/assets/img/shop/product/product-2.jpg"
                                            alt="product-img">
                                    </a>
                                    <div class="product__action transition-3">
                                        <a href="#" data-toggle="tooltip" data-placement="top"
                ...
                <div class="col-xl-12">
                    <div class="client__slider owl-carousel text-center">
                        <div class="client__thumb">
                            <a href="#"><img src="public/assets/client/assets/img/client/client-1.jpg"
                                    alt="client"></a>
                        </div>
                        <div class="client__thumb">
                            <a href="#"><img src="public/assets/client/assets/img/client/client-2.jpg"
                                    alt="client"></a>
                        </div>
                        <div class="client__thumb">
                            <a href="#"><img src="public/assets/client/assets/img/client/client-3.jpg"
                                    alt="client"></a>
                        </div>
                        <div class="client__thumb">
                            <a href="#"><img src="public/assets/client/assets/img/client/client-4.jpg"
                                    alt="client"></a>
                        </div>
                        <div class="client__thumb">
                            <a href="#"><img src="public/assets/client/assets/img/client/client-5.jpg"
                                    alt="client"></a>
                        </div>
                        <div class="client__thumb">
                            <a href="#"><img src="public/assets/client/assets/img/client/client-4.jpg"
                ...
                <div class="col-xl-12">
                    <div class="blog__slider owl-carousel">
                        <div class="blog__item mb-30">
                            <div class="blog__thumb fix">
                                <a href="blog-details.html" class="w-img"><img
                                        src="public/assets/client/assets/img/blog/blog-1.jpg" alt="blog"></a>
                            </div>
                        ...
                        <div class="blog__item mb-30">
                            <div class="blog__thumb fix">
                                <a href="blog-details.html" class="w-img"><img
                                        src="public/assets/client/assets/img/blog/blog-2.jpg" alt="blog"></a>
                            </div>
                            <div class="blog__content">
                        ...
                        <div class="blog__item mb-30">
                            <div class="blog__thumb fix">
                                <a href="blog-details.html" class="w-img"><img
                                        src="public/assets/client/assets/img/blog/blog-3.jpg" alt="blog"></a>
                            </div>
                            <div class="blog__content">
                                    ...
                                    <div class="tab-content mb-20" id="nav-tabContent">
                                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel"
                                            ...
                                            <div class="product__modal-img w-img">
                                                <img src="public/assets/client/assets/img/shop/product/quick-view/quick-big-1.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="nav-profile" role="tabpanel"
                                            ...
                                            <div class="product__modal-img w-img">
                                                <img src="public/assets/client/assets/img/shop/product/quick-view/quick-big-2.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div class="tab-pane fade" id="nav-contact" role="tabpanel"
                                            ...
                                            <div class="product__modal-img w-img">
                                                <img src="public/assets/client/assets/img/shop/product/quick-view/quick-big-3.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="nav nav-tabs justify-content-between" id="nav-tab" role="tablist">
                                            <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab"
                                                ...
                                                <div class="product__nav-img w-img">
                                                    <img src="public/assets/client/assets/img/shop/product/quick-view/quick-sm-1.jpg"
                                                        alt="">
                                                </div>
                                            </a>
