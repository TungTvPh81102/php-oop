                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                    <div class="footer__widget mb-30">
                        <div class="footer__widget-title mb-25">
                            <a href="index.html"><img src="public/assets/client/assets/img/logo/logo-2.png"
                                    alt="logo"></a>
                        </div>
                            ...
                            <div class="footer__contact">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="text">
                                            <span>Email: <a href="https://wphix.com/cdn-cgi/l/email-protection"
                                                    class="__cf_email__"
                                                    data-cfemail="42012d2c36232136022023312b21362a272f276c212d2f">[email&#160;protected]</a></span>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="icon">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-7">
                    <div class="footer__copyright">
                        <p>Copyright © <a href="index.html">Outstock</a> all rights reserved. Powered by <a
                                href="index.html">Theme_pure</a></p>
                    </div>
                </div>
